var Insurance = Class.create(Checkout, {
...
var InsuranceMethod = Class.create();
InsuranceMethod.prototype = {
        ...
        if (this.validate()) {
            ...
            var request = new Ajax.Request(
                this.saveUrl,
                {
                    ...
                    parameters: {insurance: insurance, cost: cost}
                }
            );
        }
    },
